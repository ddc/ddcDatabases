...
class TestSQLite:
    ...
    def test_real_operations(self):
        ...
        with self.Sqlite(filepath=db_path) as session:
            ...
            assert results[0]['DatabaseModel'].name == "test1"
            ...
            # Test execute (update)
            stmt = sa.update(DatabaseModel).where(DatabaseModel.id == 1).values(name="updated_test1")
...
class TestSQLiteRealOperations:
    ...
    def test_real_fetchall(self):
        ...
        with self.Sqlite(filepath=db_path) as session:
            ...
            # Insert test data
            test_obj = DatabaseModel(id=1, name="test", enabled=True)
            ...
            assert len(results) == 1
            # Access through the model object returned by ORM select
            assert results[0]['DatabaseModel'].id == 1
            assert results[0]['DatabaseModel'].name == "test"
            assert results[0]['DatabaseModel'].enabled == True
    ...
    def test_real_fetchvalue(self):
        ...
        with self.Sqlite(filepath=db_path) as session:
            ...
            # Insert test data
            test_obj = DatabaseModel(id=1, name="test_value", enabled=True)
            session.add(test_obj)
            session.commit()
    ...
    def test_real_insertbulk(self):
        ...
        with self.Sqlite(filepath=db_path) as session:
            ...
            # Access through the model object returned by ORM select
            assert results[0]['DatabaseModel'].name == "test1"
            assert results[1]['DatabaseModel'].name == "test2" 
            assert results[2]['DatabaseModel'].name == "test3"
    ...
    def test_custom_settings_integration(self):
        ...
        with sqlite as session:
            ...
            # Insert and verify
            test_obj = DatabaseModel(id=1, name="settings_test", enabled=True)
            session.add(test_obj)
            session.commit()
