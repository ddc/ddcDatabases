...
class TestMySQL:
    ...
    def test_init_with_parameters(self, mock_get_settings):
        ...
        mysql = MySQL(
            host="customhost", port=3307, user="customuser", password="custompass", database="customdb", echo=True
        )
    ...
    def test_pool_size_parameter(self, mock_get_settings):
        ...
        mysql = MySQL(pool_size=15)

        assert mysql.pool_size == 15
    ...
    def test_max_overflow_parameter(self, mock_get_settings):
        ...
        mysql = MySQL(max_overflow=30)

        assert mysql.max_overflow == 30
    ...
    def test_pool_parameters_defaults(self, mock_get_settings):
        ...
        assert mysql.pool_size == 10
        assert mysql.max_overflow == 20
